...
const raw = [
  ...
  { title: "4th Grade STAAR Reading Practice - CA CORE Standards", id: "cmebasydw00rnfmutjwh6mind", subject: "ELA", grade: "4th" },
  // ELA - 5th Grade
  ...
  { title: "5th Grade STAAR Reading Practice (Florida BEST Standards)", id: "cmdg6sz0c02yfhz5jgbvjuz7h", subject: "ELA", grade: "5th" },
  ...
  { title: "STAAR Writing Feedback English I (w/ Pre-Reading Passage)", id: "cm7jc03z00dhyolcwauwlio1n", subject: "ELA", grade: "HS" },
  { title: "STAAR Writing Feedback English I (w/ Pre-Reading Passage)", id: "cm7m1rxof04sljllnupran90j", subject: "ELA", grade: "HS" },
  { title: "STAAR Writing Feedback English I (w/ Pre-Reading Passage)", id: "cm7oyxzz003sp107qv8edznep", subject: "ELA", grade: "HS" },
  { title: "STAAR Writing Feedback English I (w/ Pre-Reading Passage)", id: "cm7jg7hxi0gr8jfiawprlcqo7", subject: "ELA", grade: "HS" },
  { title: "STAAR Writing Feedback English II (w/ Pre-Reading Passage)", id: "cm7jhes8f0hslcqk3c82qeyeq", subject: "ELA", grade: "HS" },
  ...
  { title: "Rubric Breakdown - STAAR Essays", id: "cmkr24y2q00sqys3zs39paghe", subject: "ELA", grade: "General" },
  { title: "Rubric Breakdown - STAAR Essays", id: "cmkr67x26002a4td5io6hlftx", subject: "ELA", grade: "General" },
  { title: "Rubric Breakdown - STAAR Essays", id: "cmkr7jm8t007x759zuxvpdo7q", subject: "ELA", grade: "General" },
  ...
  { title: "The Best Taqueria Debate", id: "cmm10yi01004v1nokrpnetxm8", subject: "ELA", grade: "General", shareUrl: true },
  { title: "Your Voice - Your School", id: "cmm9n02ad00ea8ex5qlpwciuv", subject: "ELA", grade: "General", shareUrl: true },
  ...
  { title: "Calculating Unit Rates", id: "cmgujwvvz010rfuuvxffobc2f", subject: "Math", grade: "6th", shareUrl: true },
  // Math - General
  ...
  { title: "Adaptations for Survival", id: "cmg1eza09000m14gahu2fovyd", subject: "Science", grade: "General", shareUrl: true },
  { title: "Organisms and Environments", id: "cmkzowr0500zoz9z26tp7qzaj", subject: "Science", grade: "General", shareUrl: true },

  // ELA + Science
  { title: "TELPAS Writing Practice + TEKS", id: "cmhmd0o5z005l72gqdjtcbaq6", subject: "ELA + Science", grade: "General", shareUrl: true },
  ...
  // General
  { title: "TELPAS Camps", id: "cmlvenlr10129ag8hikuaggs7", subject: "General", grade: "General", shareUrl: true },
...
const subjectConfig = {
  ELA: { dot: "bg-blue-500", header: "bg-blue-600", light: "bg-blue-50", badge: "bg-blue-100 text-blue-800" },
  Math: { dot: "bg-green-500", header: "bg-green-600", light: "bg-green-50", badge: "bg-green-100 text-green-800" },
  Science: { dot: "bg-purple-500", header: "bg-purple-600", light: "bg-purple-50", badge: "bg-purple-100 text-purple-800" },
  "Social Studies": { dot: "bg-amber-500", header: "bg-amber-600", light: "bg-amber-50", badge: "bg-amber-100 text-amber-800" },
  "ELA + Science": { dot: "bg-teal-500", header: "bg-teal-600", light: "bg-teal-50", badge: "bg-teal-100 text-teal-800" },
  General: { dot: "bg-gray-500", header: "bg-gray-600", light: "bg-gray-50", badge: "bg-gray-100 text-gray-700" },
};

const subjectOrder = ["ELA", "Math", "Science", "Social Studies", "ELA + Science", "General"];
...
export default function App() {
  ...
  const subjects = ["All", "ELA", "Math", "Science", "Social Studies", "ELA + Science", "General"];
  const grades = ["All", "3rd", "4th", "5th", "6th", "7th", "8th", "HS", "General"];

  // Deduplicate by title+subject+grade (keep first occurrence)
  const deduped = useMemo(() => {
    const seen = new Set();
    return raw.filter(s => {
      const key = `${s.title.toLowerCase().trim()}|||${s.subject}|||${s.grade}`;
  ...
  }, [search, activeSubject, activeGrade, deduped]);
  ...
  const grouped = useMemo(() => {
    ...
    return Object.values(g).sort((a, b) => {
      const si = subjectOrder.indexOf(a.subject) - subjectOrder.indexOf(b.subject);
      if (si !== 0) return si;
  ...
  const getUrl = (item) => item.shareUrl
    ? `https://app.schoolai.com/share/space/${item.id}`
    : `https://app.schoolai.com/spaces/${item.id}`;
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-blue-500 px-6 py-8 shadow-lg">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-indigo-100 mt-1 text-sm">{deduped.length} unique Spaces across all subjects & grades</p>
        </div>
      </div>
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm px-6 py-4">
        <div className="max-w-5xl mx-auto flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide mr-1">Subject:</span>
            {subjects.map(s => (
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide mr-1">Grade:</span>
            {grades.map(g => (
              <button key={g} onClick={() => setActiveGrade(g)}
                ...
                {g === "All" ? "All" : g === "General" ? "Multi/General" : g === "HS" ? "High School" : `${g} Grade`}
              </button>
            ))}
          </div>
          <p className="text-xs text-gray-400">{filtered.length} space{filtered.length !== 1 ? "s" : ""} found</p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-6 space-y-4">
        ...
        {grouped.map(group => {
          const cfg = subjectConfig[group.subject] || subjectConfig.General;
              ...
              {open && (
                <div className={`${cfg.light} divide-y divide-gray-100`}>
                  {group.items.map(item => (
                    <a key={item.id} href={getUrl(item)} target="_blank" rel="noopener noreferrer"
